...
| DynaMER-BiTCN / ADF / ADF-LS / Anchor | 15_train_dynamer_bitcn.py, 16_train_dynamer_adf.py, 17_train_dynamer_adf_ls.py, 18_train_dynamer_anchor.py |
| Component ablations | 19B_train_dynamer_adf_ablation.py |
