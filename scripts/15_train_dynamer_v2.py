...
from dynamer.models.dynamer_v2_model import DynaMERv2Model
...
def make_model(run: Dict[str, Any], baseline_variant: str, model_cfg: Dict[str, Any], device: torch.device) -> DynaMERv2Model:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="15_train_dynamer_v2: DynaMER-v2 training using Stage 12 data/splits/engine.")
    parser.add_argument("--config", required=True)
    parser.add_argument("--local-paths", required=True)
    parser.add_argument("--baseline-config", default="configs/15_train_dynamer_v2.yaml")
    ...
    logger = Logger(out_dir / "15_train_dynamer_v2_log.txt")
    logger.info("Starting 15_train_dynamer_v2.")
    ...
    summary = {
        ...
        "outputs": {
            ...
            "log": str(out_dir / "15_train_dynamer_v2_log.txt"),
    ...
    print(f"7. {out_dir / '15_train_dynamer_v2_log.txt'}")
